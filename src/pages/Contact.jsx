          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="mt-8 pt-6 border-t border-gray-600">
              ...
              <p className="text-gray-400 text-sm text-center">
                I'm always open to new projects and collaborations. Let's create something amazing!
              </p>
            </div>
          </div>
          ...
          <div className="flex-1">
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  id="message" name="message" rows="3" value={formData.message}
                  onChange={handleChange} required
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="remember" className="text-gray-300 text-sm">I'd like to receive updates</label>
              </div>
